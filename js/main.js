...
function create() {
    ...
    while (abs(carx1 - posx0) <= 75 && abs(cary1 - posy0) <= 75
        || abs(carx1 - posx1) <= 75 && abs(cary1 - posy1) <= 75
        || abs(carx1 - posx2) <= 75 && abs(cary1 - posy2) <= 75
        || abs(carx1 - posx3) <= 75 && abs(cary1 - posy3) <= 75    ) {
        carx1 = 480 + 320 * (Math.round(Math.random() * 1000) / 500 - 1);
        cary1 = 320 + 170 * (Math.round(Math.random() * 1000) / 500 - 1);
    }
    ...
    while (abs(carx2 - posx0) <= 75 && abs(cary2 - posy0) <= 75
        || abs(carx2 - posx1) <= 75 && abs(cary2 - posy1) <= 75
        || abs(carx2 - posx2) <= 75 && abs(cary2 - posy2) <= 75
        || abs(carx2 - posx3) <= 75 && abs(cary2 - posy3) <= 75
        || abs(carx2 - carx1) <= 75 && abs(cary2 - cary1) <= 75    ) {
        carx2 = 480 + 320 * (Math.round(Math.random() * 1000) / 500 - 1);
        cary2 = 320 + 170 * (Math.round(Math.random() * 1000) / 500 - 1);
    }
    ...
    while (abs(carx3 - posx0) <= 75 && abs(cary3 - posy0) <= 75
        || abs(carx3 - posx1) <= 75 && abs(cary3 - posy1) <= 75
        || abs(carx3 - posx2) <= 75 && abs(cary3 - posy2) <= 75
        || abs(carx3 - posx3) <= 75 && abs(cary3 - posy3) <= 75
        || abs(carx3 - carx1) <= 75 && abs(cary3 - cary1) <= 75
        || abs(carx3 - carx2) <= 75 && abs(cary3 - cary2) <= 75    ) {
        carx3 = 480 + 320 * (Math.round(Math.random() * 1000) / 500 - 1);
        cary3 = 320 + 170 * (Math.round(Math.random() * 1000) / 500 - 1);
    }
    ...
    while (abs(carx4 - posx0) <= 75 && abs(cary4 - posy0) <= 75
        || abs(carx4 - posx1) <= 75 && abs(cary4 - posy1) <= 75
        || abs(carx4 - posx2) <= 75 && abs(cary4 - posy2) <= 75
        || abs(carx4 - posx3) <= 75 && abs(cary4 - posy3) <= 75
        || abs(carx4 - carx1) <= 75 && abs(cary4 - cary1) <= 75
        || abs(carx4 - carx2) <= 75 && abs(cary4 - cary2) <= 75
        || abs(carx4 - carx3) <= 75 && abs(cary4 - cary3) <= 75    ) {
        carx4 = 480 + 320 * (Math.round(Math.random() * 1000) / 500 - 1);
        cary4 = 320 + 170 * (Math.round(Math.random() * 1000) / 500 - 1);
    }
...
function update(time,delta) {
    people1.x += 1;//这里写每个精灵对象的位置操作 在很小的时间间隔内执行一次这个函数
}
